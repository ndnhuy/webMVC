...
public class ProductController extends AbstractController {
    ...
    public void getProductByIdAction(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        try {
    ...
    public void createOrUpdateProductAction(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        try {
            ...
            product.setCategoryId(new Long(req.getParameter("productCategory")));
